...
function CreateEncounterNpcForm(){
    ...
    function handleSubmit(e, obj){
        ...
        const configObj = {
            ...
            body: JSON.stringify(newEncNpc)
        }
        fetch("/newencnpc", configObj)
        .then(r => r.json())
        .then(data =>{
            console.log(data)
    ...
    <Container>
         <Form onChange={handleChange} onSubmit={(e) => handleSubmit(e, form)}>
            ...
            <Form.Group>
                <Form.Label>Npc Image:</Form.Label>
...
export default CreateEncounterNpcForm;